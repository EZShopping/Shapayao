...
if(isset($_SESSION["cart_session"]))
{
    ...
    foreach ($_SESSION["cart_session"] as $cart_itm)
    {
		...
		echo '<span>Shopping Cart ( '.$cart_itm["Product Number"].') </span>';
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; hopAyao <a href="index.php"><i><font color="fefefe"> Welcome To <strong> ShopAyao</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
