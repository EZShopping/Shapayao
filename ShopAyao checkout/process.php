...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="e.g. " type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="e.g." type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> Phone:</label>
                                <input id="phone" name="phone" placeholder="e.g. +63***********" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="e.g. " type=" text" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
								Remember, If You Proceed it Now You Can Find Your Sales Voucher Or Payment Voucher In Your Mail Box In A Few Minutes.
							</p>
                            <p class="submit">
