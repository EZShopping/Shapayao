                        ...
                        <div id="log_in" class="animate form">
                            <form  action="userValidate.php" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input type="text" name="magaca" required="required" type="text" placeholder="shopayao@gmail.com"/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your Password </label>
                                    <input type="password" name='admin' required="required" type="password" placeholder="eg. ****" /> 
                                </p>
                                <p class="keeplogin"> 
