...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
          ...
          while($obj = $results->fetch_object())
        {
            ...
            echo '<td class="p-qty">Qty :<input type="text" name="product_qty" value="'.$cart_itm["Product Number"].'" size="2"   maxlength="5" /></td>';
			...
			echo '<input type="hidden" name="item_qty['.$cart_items.']" value="'.$cart_itm["Product Number"].'"/>';
			$cart_items ++;
			      		    }}}
		...
		echo '<spa class="midigta"><a  class="a-btn" href="ShopAyao checkout/process.php"><span class="a-btn-text"></span> </a></span>';
		
		echo '<span class="midigta"> <a  class="a-btn" href="ShopAyao checkout/process.php"> <span class="a-btn-text"> Pay On ShopAyao with COD</span></a></span>';
		echo '</span>';
		echo '</form>';
		

   }else{        
		echo '<span class="shop"><i>Your Cart is empty</i></span>';
	}
