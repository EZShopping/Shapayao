...
?>
 ...
 <div class="clear"></div>
	...
	$results = $mysqli->query("SELECT * FROM product where Warehouse_ID=1 ORDER BY Product_ID ASC");
    if ($results) { 
		...
		<div id="footer">
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							...
							<p>ShopAyao is an e-commerce platform for the region. Fullfiling the excitment and happiness of our customers online shopping experience. ShopAyao rpovides you the easy, secure and fast online shopping. And gives you different products options from different online sellers.
</p>
							<div class="cl">&nbsp;</div>
						</div>
					</div>
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2021 ShopAyao All rights reserved. For Project Purpose only
				</div>
				<!-- End Shell -->
			</div>
		</div>
