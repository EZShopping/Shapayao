...
<div id="container">
	   ...
	   <div id="header">
		...
		<div id="logo-banner">
				...
				<a href="index.php"><img src="images/img/Logo.png" alt="" /></a>
				</div>
...
<aside id="sidebar" class="column">
				...
				<!-- End Search -->
		<hr/>
		<h3> ShopAyao Database Backup:</h3>
		<ul class="toggle">
	...
	<h4 class="alert_info">Welcome To <strong>"ShopAyao"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4>
            ...
            $('.user').keyup(function() {
                ...
                if (this.value.match(/[^a-zA-Z]/g)) {
                    ...
                    this.value = this.value.replace(/[^a-zA-Z ]/g, '');
					 window.alert("Pls. In A UserName Field Only Charecters Allowed !");
                }
...
?>
  ...
  <table class="tablesorter" cellspacing="0"> 
			...
			<thead>  <th Colspan="11">  ShopAyao Product Data Table </th></thead>
		<thead>
			</tr>
   		      <th>Check</th> 
    	      <th>ID</th>
